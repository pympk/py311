...
Review tests, make sure they are Integration/System Audit   
-- You just correctly identified the difference between a Unit Test and an Integration/System Audit.  
===
Identifying Redundancy
I've realized the observation space contains redundant data. Examining builder.py, both raw and Z-scored versions of features like Macro_Trend and Macro_Vix_Ratio are present. This collinearity is detrimental for neural networks, though somewhat acceptable in RL. To remedy this without disrupting the pipeline, a RunningStandardScaler is the best universal fix, which will Z-score all data on the fly.
